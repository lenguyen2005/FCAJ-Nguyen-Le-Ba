...
* Understand how to manage and optimize costs when using AWS services.
* Get familiar with EC2.
...
* Understood how to manage costs when using AWS services.
* Learned how to create an EC2 instance and practice some basic operations.
